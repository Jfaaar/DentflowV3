...
export const ROUTES = {
  ...
  app: {
    ...
    patientPerio: (id: string) => `/app/patients/${id}/perio`,
    patientEndo: (id: string) => `/app/patients/${id}/endo`,
    patientOrtho: (id: string) => `/app/patients/${id}/ortho`,
    patientInsurance: (id: string) => `/app/patients/${id}/insurance`,
    dentalLabCases: '/app/dental/lab-cases',
...
export const APP_TAB_TO_PATH: Record<string, string> = {
  ...
  dentalLab: ROUTES.app.dentalLabCases,
