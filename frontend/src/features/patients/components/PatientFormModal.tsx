...
import { User, Mail, Phone, Calendar, HeartPulse, Shield, MapPin } from 'lucide-react';
            ...
            <div className="space-y-5">
                ...
                <div className="flex gap-4">
                    <div className="flex-1 space-y-1.5">
                        ...
                        <select 
                            className="w-full px-3 py-2 rounded-xl border border-surface-300 dark:border-surface-600 bg-white dark:bg-surface-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                            value={gender}
                    ...
                    <div className="flex-1 space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="date"
                                className="w-full pl-10 px-3 py-2 rounded-xl border border-surface-300 dark:border-surface-600 bg-white dark:bg-surface-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                                value={birthDate}
